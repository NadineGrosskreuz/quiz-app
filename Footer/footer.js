export default function Footer(footerElement, siteElement) {
  ...
  const houseIconFilled = footerElement.querySelector(
    '[data-js="house_icon_filled"]'
  );
  const bookmarkIconFilled = footerElement.querySelector(
    '[data-js="bookmark_icon_filled"]'
  );
  const pageIconFilled = footerElement.querySelector(
    '[data-js="page_icon_filled"]'
  );
  const accountIconFilled = footerElement.querySelector(
    '[data-js="account_icon_filled"]'
  );
